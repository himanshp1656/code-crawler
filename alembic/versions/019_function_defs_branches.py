...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("upstream_ids", JSONB, nullable=False, server_default="'[]'::jsonb"),
        sa.Column("downstream_ids", JSONB, nullable=False, server_default="'[]'::jsonb"),
        sa.Column("base_class_ids", JSONB, nullable=False, server_default="'[]'::jsonb"),
        sa.Column("relationships", JSONB, nullable=False, server_default="'[]'::jsonb"),
        sa.Column("unresolved_bases", JSONB, nullable=False, server_default="'[]'::jsonb"),
        sa.Column("created_at", sa.TIMESTAMP(timezone=True), server_default=sa.func.now()),
